...
export default function CreateRecipePage() {
  ...
  // Simplified ingredient and step management
  ...
  // Update the hidden form values when ingredients or steps change
  useEffect(() => {
    setFormData(prev => ({
      ...prev,
      ingredients: ingredients
        .filter(item => item.name.trim()) // Only include ingredients with names
